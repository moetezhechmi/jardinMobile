 ...
 * @author ASUS
 */
public class IncidentForm  extends  SideMenuBaseForm{

   private static final int[] COLORS = {0xf8e478, 0x60e6ce, 0x878aee};
    private static final String[] LABELS = {"Design", "Coding", "Learning"};

    public IncidentForm(Resources res) {
               super("incidents", BoxLayout.y());
        ...
        Container titleCmp = BoxLayout.encloseY(
                ...
                new Label("Incidents", "CenterTitle")
        ...
        add(BorderLayout.center(
         ...
         img.addPointerReleasedListener((l)->{
                                      new AddIncident(this,res).show();
    

        });
             img2.addPointerReleasedListener((l)->{
                                                       new ListIncident(this,res).show();
